...
ActiveRecord::Schema[8.1].define(version: 2026_05_16_022220) do
  ...
  create_table "ai_guidelines", force: :cascade do |t|
    t.boolean "active", default: true, null: false
    t.text "after_verse"
    t.text "before_verse"
    t.text "body"
    t.datetime "created_at", null: false
    t.string "kind", default: "principle", null: false
  ...
  create_table "selections", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["kukai_id"], name: "index_selections_on_kukai_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "ai_comment_model", default: "openai", null: false
    t.string "ai_comment_style", default: "normal", null: false
    t.datetime "created_at", null: false
  ...
  add_foreign_key "selections", "kukais"
